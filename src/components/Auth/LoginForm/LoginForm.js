...
export function LoginForm() {
    ...
    const formik = useFormik({
      ...
      validateOnChange: false, //se pone false para que no valide mientras voy escribiendo
  ...
  return (
    <View style={styles.content}>
      ...
      <Input placeholder='Contraseña' containerStyle={styles.input} secureTextEntry={showPassword ? false : true} rightIcon={<Icon type='material-community' name={showPassword ? 'eye-off' : 'eye-outline'} iconStyle={styles.icon} onPress={onShowHidePassword} />} onChangeText={text => formik.setFieldValue("password", text)} errorMessage={formik.errors.password} />
